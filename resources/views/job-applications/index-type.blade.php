                ...
                <div class="col-12">
                    <div class="card mb-4 ">
                        <div class="d-flex">
                            ...
                            <h6 class="mt-3 mb-2 ms-3 "> Job Applications - {{ucwords(str_replace("-"," ",request()->type))}} </h6>
                        </div>
                                ...
                                <div class="row"> 
                                    <div class="col-2">
                                        <div class="input-group input-group-outline mb-3">
                                            <select name="status" id="status" class="form-control form-filter" placeholder="Status" @if(request()->type !=='in-progress') disabled @endif>
...
<script>
    ...
    (function () {
        ...
        @else
            // document.getElementById('status').value = '{{ucwords(request()->type)}}';
        @endif
